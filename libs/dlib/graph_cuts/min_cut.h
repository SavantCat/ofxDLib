...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        ) const
        {
            ...
            const unsigned long _nil = g.number_of_nodes();

            parent.assign(g.number_of_nodes(), _nil);
            ...
            while (orphans.size() > 0)
            {
                ...
                if (label_p == SOURCE_CUT)
                {
                    ...
                    for(in_edge_iterator q = begin; q != end; ++q)
                    {
                        ...
                        unsigned long temp = distance_to_origin(_nil, id,source);
                        if (temp < best_dist)
                        {
                            best_dist = temp;
                            best_node = id;
                ...
                else
                {
                    ...
                    for(out_edge_iterator q = begin; q != end; ++q)
                    {
                        ...
                        unsigned long temp = distance_to_origin(_nil, id,sink);
