...
meta:
	ADDON_NAME = ofxDLib
	ADDON_DESCRIPTION = Wrapper for DLib and data type conversion from and to openFrameworks.
	ADDON_AUTHOR = Roy Macdonald
	ADDON_TAGS = "dlib"
	ADDON_URL = http://github.com/roymacdonald/ofxDLib
...
common:
	...
	# addon
	# ADDON_CFLAGS =
	ADDON_CPPFLAGS = -DDLIB_PNG_SUPPORT
	ADDON_CPPFLAGS += -DDLIB_JPEG_SUPPORT
...
#	ADDON_SOURCES += src/ofxDLib.cpp
	...
	ADDON_INCLUDES += libs/dlib/libjpeg/include/
	ADDON_LIBS = libs/dlib/libjpeg/osx/libjpeg.a

	ADDON_INCLUDES += libs/dlib/libjpeg/include/
	ADDON_LIBS += libs/dlib/libpng/osx/libpng16.a
